        ...
        <main>
            <section className='px-8 py-16 mt-16 border-b-2 border-gray-200'>
                <h1 className='text-[2rem] font-medium'>
                    Empowering Girls Through Education in West Java
                </h1>
                ...
                <div className="flex flex-row">
                    ...
                    <p className="my-auto font-medium">Kiara Kurniawan is organizing this fundraiser.</p>
                </div>
            </section>

            <section className='px-8 py-16 border-b-2 border-gray-200'>
                <p className="mb-4">
                    Thousands of girls in West Java face barriers to education due to poverty. This campaign aims to
                    provide scholarships, school supplies, and mentorship programs to help them achieve their dreams.
            ...
            <section className='px-8 py-16'>
                <div className="relative flex flex-row justify-between mb-4">
                    <p className="text-[1.5rem] font-bold text-blue-800">Rp 123.456.789 raised</p>
                    <p className="absolute right-0 px-6 py-2 text-gray-400 border-gray-400 rounded-2xl border-2">100 donations</p>
                </div>
                <p className="mb-4">Rp 200.000.000 goal</p>
                        ...
                        <div className="flex flex-col gap-4 mt-4">
                            <div className="flex flex-row">
                                ...
                                <div className="grow ml-4">
                                    ...
                                    <div className="flex flex-row justify-between">
                                        <p className="my-auto text-[.8rem]">Rp 100.000</p>
                                        <p className="text-gray-400">30 seconds ago</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-row">
                            ...
                            <div className="flex flex-row">
                                ...
                                <div className="grow ml-4">
                                    ...
                                    <div className="flex flex-row justify-between">
                                        <p className="my-auto text-[.8rem]">Rp 100.000</p>
                                        <p className="text-gray-400">7 minutes sago</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-row">
                                ...
                                <div className="grow ml-4">
                                    ...
                                    <div className="flex flex-row justify-between">
                                        <p className="my-auto text-[.8rem]">Rp 100.000</p>
                                        <p className="text-gray-400">11 minutes ago</p>
                                    </div>
                                </div>
                            </div>
                        </div>
